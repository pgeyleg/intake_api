...
RSpec.configure do |config|
  ...
  config.before(:example, elasticsearch: true) do
    [ScreeningsRepo, PeopleRepo].each do |repo|
      repo.delete_index! && repo.create_index! if repo.index_exists?
    end
  end
  ...
  config.around(:each) do |example|
    WebMock.disable_net_connect!(allow_localhost: true, allow: %r{elasticsearch})
    example.run
